...
import com.step.robot.config.error.AppException;
import com.step.robot.config.error.EnumError;
import com.step.robot.entity.result.DataResult;
import com.step.robot.entity.scene.Scene;
import com.step.robot.socket.SocketSession;
import com.step.robot.utils.TextUtils;
